...
import com.example.chatsop.Adaptor.MessageAdaptor;
import com.example.chatsop.Adaptor.UserAdaptor;
import com.example.chatsop.Fragments.APIService;
import com.example.chatsop.Model.Chat;
import com.example.chatsop.Model.User;
import com.example.chatsop.Notifications.Client;
import com.example.chatsop.Notifications.Data;
        ...
        chatRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    chatRef.child("time").setValue(System.currentTimeMillis());
                } else {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    messageAdaptor = new MessageAdaptor(MessageActivity.this, mchat, imageurl);
